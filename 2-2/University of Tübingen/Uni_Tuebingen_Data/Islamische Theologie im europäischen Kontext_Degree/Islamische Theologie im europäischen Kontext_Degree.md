# Islamische Theologie im europäischen Kontext_Degree
...
[Islamic Theology](/en/faculties/center-for-islamic-theology/center/)
...
###### [On what criteria are applicants selected?](#412-requirements-and-application-0-pc)

Dieser Masterstudiengang ist formal zulassungsfrei. Es ist jedoch eine fristgerechte Bewerbung über das [Online-Bewerbungsportal](http://www.uni-tuebingen.de/studium/bewerbung-und-immatrikulation/bewerbung-masterstudium.html "Opens internal link in current window") der Universität Tübingen notwendig, auf deren Grundlage die StudiengangskoordinatorInnen prüfen, ob die Zulassungsvoraussetzungen erfüllt sind.
...
[Hier erhalten Sie alle wichtigen Informationen zur Bewerbung für einen Masterstudiengang.](/en/study/application-and-enrollment/masters-degree/ "Opens internal link in current window")

Für weitere Rückfragen steht Ihnen das [Studierendensekretariat](/en/facilities/administration/iv-student-affairs/student-administration/student-administration/ "Opens internal link in current window") gerne zur Verfügung.

###### [Which requirements must I meet for studies?](#412-requirements-and-application-1-pc)
...
###### [Which languages must I know?](#412-requirements-and-application-2-pc)
...
###### [Which topics are dealt with in the program?](#412-course-details-0-pc)
...
###### [What is special about the Tübingen program?](#412-course-details-1-pc)
...
###### [Is study abroad expected?](#412-course-details-3-pc)

In jedem Studiengang ist ein freiwilliger Auslandsaufenthalt möglich. Mit der Planung sollte ca. ein bis eineinhalb Jahre vor der Abreise begonnen werden.   
 Weitere Informationen und Beratung zum Auslandsstudium finden Sie auf der fachübergreifenden Seite [Wege ins Ausland](https://uni-tuebingen.de/international/studieren-im-ausland/wege-ins-ausland/).

Zudem bietet [ZITh einige Informationen zu Auslandsaufenthalten](https://uni-tuebingen.de/fakultaeten/zentrum-fuer-islamische-theologie/international/) an.
...
###### [What else do I need to know?](#412-course-details-4-pc)

Das Zentrum verfügt über eine eigene Bibliothek und garantiert mit seiner familiären Atmosphäre eine individuelle Betreuung seiner Studierenden.

**Facts and figures:**

In diesem Studiengang sind im Wintersemester 2019/20 22 Studierende eingeschrieben.

###### [Module handbook](#412-course-details-5-pc)

[Hier erhalten Sie die Prüfungsordnungen und Modulhandbücher](/en/fakultaeten/zentrum-fuer-islamische-theologie/studium/studienangelegenheiten/downloads/ "Opens internal link in current window")

###### [Exam regulations](#412-course-details-6-pc)
