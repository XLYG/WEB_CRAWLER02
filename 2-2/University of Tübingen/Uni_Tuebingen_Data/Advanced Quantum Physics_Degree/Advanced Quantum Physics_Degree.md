# Advanced Quantum Physics_Degree
...
###### [On what criteria are applicants selected?](#772-requirements-and-application-0-pc)

This degree program has no special requirements for admission. That means you will be allocated a place in the program if you meet the general requirements. However, you need to [apply](/en/study/application-and-enrollment/masters-degree/) in order to establish whether you meet the general requirements.

###### [Which requirements must I meet for studies?](#772-requirements-and-application-1-pc)
...
###### [Which languages must I know?](#772-requirements-and-application-2-pc)

Course language is English (GER B2-C1 (Testdaf4444 or DSH2)).

###### [Which other subjects can I combine with my main subject?](#772-requirements-and-application-3-pc)
...
###### [Which topics are dealt with in the program?](#772-course-details-0-pc)

The scientific profile of the area quantum science is defined by the working groups of the [Center for Quantum Science](/en/faculties/faculty-of-science/departments/physics/research/quantum-science/) (CQ). They deal with atom-light-interactions, Rydberg physics, quantum sensors, quantum gases in magnetical and optical traps, optical and microwave resonators, many-body quantum systems, and hybrid systems consisting of ultracold atoms and superconducting structures. These are all platforms in which quantum technologies are build up.

###### [What is special about the Tübingen program?](#772-course-details-1-pc)
...
###### [How is the program structured?](#772-course-details-2-pc)
...
###### [Is study abroad expected?](#772-course-details-3-pc)

Information on the [Erasmus program](/en/faculties/faculty-of-science/departments/physics/studies/international/) (Uppsala, Schweden) for students of the Department of Physics
...
###### [What else do I need to know?](#772-course-details-4-pc)

**Facts and figures:**

In the winter term 2024/25 approximately 870 students are enrolled in these physics programs, among others:
