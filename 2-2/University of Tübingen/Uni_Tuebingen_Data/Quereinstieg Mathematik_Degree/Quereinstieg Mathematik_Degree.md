# Quereinstieg Mathematik_Degree

## Key data on study program

**Faculty**
  
[Mathematisch-Naturwissenschaftliche Fakultät](/en/faculties/faculty-of-science/faculty/)
...
[Apply now](https://uni-tuebingen.de/de/116955)
...
###### [On what criteria are applicants selected?](#946-requirements-and-application-0-pc)
...
This degree programme is free of admission, i.e. you will receive a place on the programme if you meet the admission requirements. An [application](/en/study/application-and-enrollment/masters-degree/) is nevertheless required to check these prerequisites. You can begin your studies in either the winter or summer semester.

###### [Which requirements must I meet for studies?](#946-requirements-and-application-1-pc)
...
###### [Which languages must I know?](#946-requirements-and-application-2-pc)
...
International applicants \*without\* a German-language university entrance qualification must provide proof of German language proficiency in accordance with the [university´s matriculation regulations](https://uni-tuebingen.de/en/studium/bewerbung-und-immatrikulation/allgemeine-informationen-zur-bewerbung/zulassungs-und-immatrikulationsordnung-der-universitaet-tuebingen/) (see also [information on proof of linguistic study ability / DSH language test)](https://uni-tuebingen.de/en/international/learning-languages/tests-and-certificates/dsh-exam/).

###### [Which other subjects can I combine with my main subject?](#946-requirements-and-application-3-pc)
...
###### [Which topics are dealt with in the program?](#946-course-details-0-pc)
...
An overview and timetables can be found on the [website](/en/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/informatik/studium/studierende/lehre-studienorganisation/studiengaenge/informatik-lehramt/med-quereinstieg-lehramt-gymnasium/) of the Quereinstieg M. Ed. Informatik.
...
###### [What is special about the Tübingen program?](#946-course-details-1-pc)
...
For further information, students can contact the relevant subject advisors and the [Dean of Studies](# "Opens window for sending email").

###### [How is the program structured?](#946-course-details-2-pc)
...
###### [Is study abroad expected?](#946-course-details-3-pc)
...
Further information can be found under [Study Abroad](/en/faculties/faculty-of-science/departments/mathematics/department/courses-programs/students/studying-abroad/).
...
###### [What else do I need to know?](#946-course-details-4-pc)

**Facts and figures:**

In the winter semester 2024/25, approximately 730 students will be studying at the Department of Mathematics:

|  |  |
| --- | --- |
| Mathematik B.Sc.: | 176 |
| Mathematik M.Sc.: | 51 |
| Mathematical Physics M.Sc.: | 40 |
| Mathematik B.Ed.: | 282 |
| Mathematik B.Ed. berufl. Lehramt: | 3 |
| Mathematik Vorleistungen Erweiterungsfach: | 6 |
| Mathematik M.Ed.: | 125 |
| Mathematik Quereinstieg Lehramt M.Ed.: | 12 |
| Mathematik Promotion: | 32 |

###### [Module handbook](#946-course-details-5-pc)

The module handbook describes the objectives and structure of a degree programme. You will find more detailed information on the type and scope of all modules as well as their courses, requirements and examinations in the module handbook of the [M.Ed. Lateral Entry degree programme](/en/faculties/faculty-of-science/departments/mathematics/department/courses-programs/study-programmes/master-of-education-lehramt-gymnasium-erweiterungsfach-1/). A typical study plan in the module handbook helps you to plan your studies. The module handbook and the examination regulations help you to understand the framework conditions of your degree programme and to select the right modules/courses.

###### [Exam regulations](#946-course-details-6-pc)

The study and examination regulations for the [QM.Ed. Lateral Entry (computer science - physics - mathematics)](/en/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/studium/satzungen/informatik-med-quereinstieg-ipm/) contain legally binding regulations for the study programme. Among other things, they specify which modules must be completed and which examinations must be taken in order to successfully complete the degree programme. The study and examination regulations also regulate how often examinations can be repeated, which deadlines apply to the examinations of a degree programme and how the final grade is calculated. The examination regulations and the module handbook help you to understand the framework conditions of your degree programme and to select the right modules and courses.

## Help with choosing a study program

###### [Is the program right for me?](#946-course-decision-0-pc)
