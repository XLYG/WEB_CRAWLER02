...
###### [On what criteria are applicants selected?](#289-requirements-and-application-0-pc)

Admission requirements for the Master's program are a successful degree (Bachelor's degree with at least a grade of 3.0) in geography or a related field (see requirements). Otherwise, this study program is free of admission insofar as the admission requirements are met, i.e. no application is necessary. You can [enroll](https://uni-tuebingen.de/en/study/application-and-enrollment/enrolling-at-the-university-of-tuebingen/) for this program directly for the winter semester (deadline September 15).

###### [Which requirements must I meet for studies?](#289-requirements-and-application-1-pc)
...
###### [Which languages must I know?](#289-requirements-and-application-2-pc)
...
International applicants without a German-language university entrance qualification must prove sufficient knowledge of the German language (DSH-3 or TestDaF-4) in accordance with the university's [immatriculation regulations](https://uni-tuebingen.de/en/studium/bewerbung-und-immatrikulation/allgemeine-informationen-zur-bewerbung/zulassungs-und-immatrikulationsordnung-der-universitaet-tuebingen/) (see also information on [proof of language ability to study / DSH language test](https://uni-tuebingen.de/en/international/learning-languages/tests-and-certificates/dsh-exam/)).

###### [Which other subjects can I combine with my main subject?](#289-requirements-and-application-3-pc)
...
###### [Which topics are dealt with in the program?](#289-course-details-0-pc)
...
###### [What is special about the Tübingen program?](#289-course-details-1-pc)
...
###### [How is the program structured?](#289-course-details-2-pc)
...
###### [Is study abroad expected?](#289-course-details-3-pc)
...
Information about studying abroad / [ERASMUS-Programme](https://uni-tuebingen.de/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/geowissenschaften/studium/international-1/):

* Dr. T. Sedelmeier
* 07071 29 73940
* [timo.sedelmeierspam prevention@uni-tuebingen.de](#)
...
###### [What else do I need to know?](#289-course-details-4-pc)
...
In the winter semester 2024/25, a total of approximately 700 students are enrolled for geography in all degrees in the following study programs:
