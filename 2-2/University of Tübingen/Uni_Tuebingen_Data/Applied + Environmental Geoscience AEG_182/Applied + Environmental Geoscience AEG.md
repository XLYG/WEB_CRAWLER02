...
###### [Which requirements must I meet for studies?](#182-requirements-and-application-1-pc)
...
* good background in **mathematics**, **chemistry**, **physics** (i.e. courses must be included in the Bachelor's curriculum) and **geosciences**
...
For further information see the [AEG website](/en/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/geowissenschaften/studium/studiengaenge/applied-environmental-geoscience/counseling-and-application/); to apply for the program please follow the [online application procedure on the University's website.](/en/study/application-and-enrollment/masters-degree/)

###### [Which languages must I know?](#182-requirements-and-application-2-pc)
...
###### [Which topics are dealt with in the program?](#182-course-details-0-pc)
...
[for detailed information see the AEG website](/en/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/geowissenschaften/studium/studiengaenge/applied-environmental-geoscience/)

###### [What is special about the Tübingen program?](#182-course-details-1-pc)
...
###### [How is the program structured?](#182-course-details-2-pc)
...
###### [Is study abroad expected?](#182-course-details-3-pc)

A study abroad period is not expected.  
For an optional study abroad you find information here: [Erasmus+ program in AEG](/en/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/geowissenschaften/studium/international-1/erasmus-geo-und-umweltnaturwissenschaften/)
...
###### [What else do I need to know?](#182-course-details-4-pc)

**Facts and figures:**

Im Wintersemester 2024/25 sind für Applied & Enviromental Geoscience (AEG) rund 70 Studierende eingeschrieben.

###### [Module handbook](#182-course-details-5-pc)

The [AEG Module Handbook](/en/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/geowissenschaften/studium/studiengaenge/applied-environmental-geoscience/information-for-students/) describes the qualification goals and structure of the program, will help you to plan your studies and select the right modules, and specifies the study contents (type and scope of all modules, their courses, prerequisites and exams).