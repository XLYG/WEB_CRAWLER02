...
**Limited capacity:** **First semester:** no
**Higher semester:** no

**Application possible for:** **First semester:** winter and summer term
**Higher semester:** winter and summer term

**Application deadline:** **German and EU nationals**
...
In the Master of Education in Geography, you will deepen your knowledge of **physical, human and regional geography** and deal with current issues in **spatial and environmental research, urban and regional development** and **socially relevant topics** . You will learn to **analyze, evaluate and scientifically process geographical structures and processes** , both in the field and in a theoretical context.

The master's degree combines **in-depth subject knowledge** with **subject-specific didactic practice** and prepares you specifically for the **preparatory service for the teaching profession** . You will develop the ability to **prepare specialist geographical knowledge in such a way that learners can understand it and apply it independently** , and acquire skills in dealing with **subject-relevant media and methods** in order to convey teaching content clearly.
...
In the Geography major your modules are:

**compulsory modules:**

- **Applied Regional Geography** (9 CP)
- **Subject Didactics of Geography** (7 CP)

**Methods (compulsory elective, 5 CP)**

- **Regional Problems and Planning Concepts in Developing Countries** (5 CP)
- **Geology** (5 CP)
- **Hydrology** (5 CP)
- **Basics of Urban Planning** (5 CP)
- **Remote Sensing for Teachers in Geography** (5 CP)

**Consolidation (compulsory elective, 6 CP)**

- **Water and Element Cycling in Ecosystems** (6 CP)
- **Cultural Geography** (6 CP)
- **Sustainable Management of Rivers and Floodplains** (6 CP)
- **Vegetation Science** (6 CP)
- **Mobility and Society** (6 CP)
- **Urban Ecology** (6 CP)
...
**Start of studies in the winter term**

**1st semester**

- **Applied Regional Geography** prepatory seminar "Spain" or "Amazon" (3 CP) field trip "Spain" or "Amazon" (6 CP)

**2nd semester**

- **Methods** courses according to chosen module (5 CP)
- **Subject Didactics of Geography II** seminar "Subject Didactics Master" (4 CP) Geography Education Research Workshop (3 CP)

**4th semester**

- **Consolidation** courses according to chosen module (6 LP)
...
- **Psychological Fundamentals** lecture "Educational Psychology" (2 CP)
- **Basic Studies in Ethics and Philosophy 2** seminar "Basic Studies in Ethics and Philosophy" (6 CP)

- **Psychological Fundamentals** lecture "Developmental Psychology" (2 CP)
- **School Structures** School Structures Course 1 (2 CP)
- **Basic of Didactics and Methodology** lecture and seminar "Didactics and Methodology" or lecture and seminar "Didactics and Methodology of STEM subjects and in Sports" (4 CP)

**3rd semester**

- **Personal Competence** compulsory elective seminar 1 and 2 (4 CP)
- **School Structures** School Structures Course 2 and 3 (4 CP)

- **Research Methods** project seminar "Research Methods for Teaching Profession" (4 CP)
- **Inclusion** lecture "Inclusive Education in Adolescence" (3 CP) seminar "Inclusive Education" (2 CP)
...
The requirements for admission to the **major subject Geography** in the master's degree program **Secondary School Teaching Degree** are based on the current admission regulations :

- **bachelor's degree**
- **admission with a subject-related bachelor's degree**
- **proof** of **personal aptitude** as a future teacher: participation in the Karlsruhe Individual Aptitude Check for Teachers (KAiAC-T) or an equivalent aptitude, advisory or support program. proof can be submitted at a later date up to the end of the first semester.
- **minimum knowledge and minimum achievements in the following areas** Climatology amounting to 2 CP Biogeography or Vegetation Science amounting to 2 CP Geomorphology amounting to 2 CP Soil Sciences amounting to 2 CP Population Geography (2 CP) Economic Geography amounting to 2 CP Urban Geography (2 CP) Regional Planning (2 CP) Cartography (2 CP) Geographic Information Systems (2 CP) Statistics (2 CP) Geographical field trips amounting to 2 CP Geographical field exercises amounting to 3 CP two seminars in Geography of 2 CP each Geographical Didactics amounting to 6 CP
